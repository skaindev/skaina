...
import (
	...
	neatptc "github.com/skaindev/skaina/neatptc"
	...
	"github.com/skaindev/skaina/network/p2p/netutil"
	"github.com/skaindev/skaina/params"
	"github.com/skaindev/skaina/utilities/common"
	"github.com/skaindev/skaina/utilities/common/fdlimit"
	"github.com/skaindev/skaina/utilities/crypto"
	"github.com/skaindev/skaina/utilities/metrics"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `skaina account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func RegisterIntService(stack *node.Node, cfg *neatptc.Config, cliCtx *cli.Context, cch core.CrossChainHelper) {
	...
	if err != nil {
		Fatalf("Failed to register the skaina service: %v", err)
	}
}
