...
import (
	...
	"github.com/skaindev/skaina/utilities/console"
...
var (
	initNEATGenesisCmd = cli.Command{
		...
		Name:      "init-skaina",
		Usage:     "Initialize Skaina genesis.json file. init-skaina {\"1000000000000000000000000000\",\"100000000000000000000000\"}",
		ArgsUsage: "<genesisPath>",
		Flags: []cli.Flag{
			utils.DataDirFlag,
		},
		Category:    "BLOCKCHAIN COMMANDS",
		Description: "The init-skaina initializes a new Skaina genesis.json file for the network.",
	}
...
It expects the genesis file as argument.`,
	...
	initSideChainCmd = cli.Command{
		...
		Usage:       "skaina --sideChain=side_0,side_1,side_2 init-side-chain",
