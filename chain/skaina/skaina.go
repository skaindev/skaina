...
import (
	...
	"github.com/skaindev/skaina/chain/consensus/neatcon/consensus"
...
func neatchainCmd(ctx *cli.Context) error {
	...
	if ctx == nil {
		log.Error("oh, ctx is null, how skaina works?")
		return nil
	}

	log.Info("Skaina | Beyond payments.")
	...
	if err != nil {
		log.Error("start Skaina RPC failed")
		return err
	}
