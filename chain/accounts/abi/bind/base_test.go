...
import (
	...
	"github.com/skaindev/skaina/chain/accounts/abi/bind"
...
func (mc *mockCaller) CallContract(ctx context.Context, call skaina.CallMsg, blockNumber *big.Int) ([]byte, error) {
