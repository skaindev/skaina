...
import (
	...
	"github.com/skaindev/skaina/chain/accounts"
	"github.com/skaindev/skaina/chain/consensus"
	"github.com/skaindev/skaina/chain/consensus/neatcon"
	ntcBackend "github.com/skaindev/skaina/chain/consensus/neatcon"
	"github.com/skaindev/skaina/chain/core"
	"github.com/skaindev/skaina/chain/core/bloombits"
	"github.com/skaindev/skaina/chain/core/datareduction"
	"github.com/skaindev/skaina/chain/core/rawdb"
	"github.com/skaindev/skaina/chain/core/types"
	"github.com/skaindev/skaina/chain/core/vm"
	"github.com/skaindev/skaina/chain/log"
	"github.com/skaindev/skaina/internal/neatapi"
	"github.com/skaindev/skaina/neatdb"
	"github.com/skaindev/skaina/neatptc/downloader"
	"github.com/skaindev/skaina/neatptc/filters"
	"github.com/skaindev/skaina/neatptc/gasprice"
	"github.com/skaindev/skaina/network/node"
	...
	"github.com/skaindev/skaina/utilities/common/hexutil"
	"github.com/skaindev/skaina/utilities/event"
	"github.com/skaindev/skaina/utilities/miner"
...
func New(ctx *node.ServiceContext, config *Config, cliCtx *cli.Context,
	...
	chainDb, err := ctx.OpenDatabase("chaindata", config.DatabaseCache, config.DatabaseHandles, "skaina/db/chaindata/")
	if err != nil {
		return nil, err
	}
	pruneDb, err := ctx.OpenDatabase("prunedata", config.DatabaseCache, config.DatabaseHandles, "skaina/db/prune/")
	if err != nil {
		return nil, err
	}
	...
	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, Skaina %s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
