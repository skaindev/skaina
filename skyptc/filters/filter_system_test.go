...
import (
	...
	"github.com/skaindev/skaina"
	"github.com/skaindev/skaina/chain/core/rawdb"

	"github.com/skaindev/skaina/chain/core"
	"github.com/skaindev/skaina/chain/core/bloombits"
	"github.com/skaindev/skaina/chain/core/types"
	"github.com/skaindev/skaina/neatdb"
	"github.com/skaindev/skaina/network/rpc"
	"github.com/skaindev/skaina/params"
	"github.com/skaindev/skaina/utilities/common"
	"github.com/skaindev/skaina/utilities/event"
)
...
func TestPendingLogsSubscription(t *testing.T) {
	...
	var (
		...
		testCases = []struct {
			crit     skaina.FilterQuery
			expected []*types.Log
			c        chan []*types.Log
			sub      *Subscription
		}{

			{skaina.FilterQuery{}, convertLogs(allLogs), nil, nil},

			{skaina.FilterQuery{Addresses: []common.Address{{}, notUsedAddress}, Topics: [][]common.Hash{nil}}, []*types.Log{}, nil, nil},

			{skaina.FilterQuery{Addresses: []common.Address{firstAddr}}, append(convertLogs(allLogs[:2]), allLogs[5].Logs[3]), nil, nil},

			{skaina.FilterQuery{Addresses: []common.Address{secondAddr}, Topics: [][]common.Hash{{notUsedTopic}}}, []*types.Log{}, nil, nil},

			{skaina.FilterQuery{Addresses: []common.Address{thirdAddress}, Topics: [][]common.Hash{{firstTopic, secondTopic}}}, append(convertLogs(allLogs[3:5]), allLogs[5].Logs[0]), nil, nil},

			{skaina.FilterQuery{Addresses: []common.Address{secondAddr, thirdAddress}, Topics: [][]common.Hash{{firstTopic, secondTopic}}}, append(convertLogs(allLogs[2:5]), allLogs[5].Logs[0]), nil, nil},

			{skaina.FilterQuery{Addresses: []common.Address{firstAddr}, FromBlock: big.NewInt(2), ToBlock: big.NewInt(3)}, append(convertLogs(allLogs[:2]), allLogs[5].Logs[3]), nil, nil},

			{skaina.FilterQuery{Addresses: []common.Address{thirdAddress}, Topics: [][]common.Hash{{firstTopic, fourthTopic}}}, []*types.Log{allLogs[5].Logs[0], allLogs[5].Logs[2]}, nil, nil},
		}
	)
