...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "skaina.ipc", false, filepath.Join(os.TempDir(), "skaina.ipc")},
		{"data", "skaina.ipc", false, "data/skaina.ipc"},
		{"data", "./skaina.ipc", false, "./skaina.ipc"},
		{"data", "/skaina.ipc", false, "/skaina.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "skaina.ipc", true, `\\.\pipe\skaina.ipc`},
		{"data", "skaina.ipc", true, `\\.\pipe\skaina.ipc`},
		{"data", `\\.\pipe\skaina.ipc`, true, `\\.\pipe\skaina.ipc`},
	}
