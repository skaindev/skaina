...
import (
	...
	goCrypto "github.com/skaindev/crypto-go"
	"github.com/skaindev/skaina/chain/accounts"
	"github.com/skaindev/skaina/chain/accounts/abi"
...
var (
	minimumRegisterAmount = math.MustParseBig256("100000000000000000000000")
...
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	...
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid Skaina signature (V is not 27 or 28)")
	}
	sig[64] -= 27
...
func (s *PublicBlockChainAPI) EstimateGas(ctx context.Context, args CallArgs) (hexutil.Uint64, error) {
	...
	if e == nil && functionType != neatAbi.Unknown {
		fmt.Printf("skaina inner contract tx, address: %v, functionType: %v\n", args.To.Hex(), functionType)
...
func (args *SendTxArgs) setDefaults(ctx context.Context, b Backend) error {
	...
	if neatAbi.IsNeatChainContractAddr(args.To) {
		...
		if len(input) == 0 {
			return errors.New(`skaina contract without any data provided`)
		}
